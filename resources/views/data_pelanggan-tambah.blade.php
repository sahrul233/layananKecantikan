...
<form class="card" action="/data_pelanggan/edit" method="POST">
    ...
    <div class="card-header">
        <h4 class="judul-jadwal">Tambah Pelanggan</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <label for="pilihan_tempat" class="form-label">Tempat</label>
            <select class="form-select" id="pilihan_tempat" name="pilihan_tempat">
